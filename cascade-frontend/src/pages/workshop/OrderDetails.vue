...
export default {
  ...
  computed: {
    ...mapState(['repairOrderList', 'token']),
  },
  beforeMount() {
    ...
    if(this.order.issueDate === '0001-01-01') {
  ...
  methods: {
    ...
    printAcceptanceCertificate() {
      ...
      this.generated = true
      this.notificationMessage = 'Сейчас начнется повторная загрузка акта приема на ремонт'
    },
    showEditPage() {
